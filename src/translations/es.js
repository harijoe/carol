const es = {
  ...
  'user.profile.email.to_validate': 'Dirección de correo electrónico no verificada',
  'user.profile.email.validate': 'Dirección de correo electrónico verificada',
  'user.profile.mobile.to_validate': 'Número de teléfono móvil no verificado',
  'user.profile.mobile.validate': 'Número de teléfono móvil verificado',
