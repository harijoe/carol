...
it('should dispatch TESTIMONIAL_ARTICLES_RECEIVE with articles', () => {
  ...
  nock(config.apiUrl)
    .get(`/posts?tag[]=testimony&itemsPerPage=10&order[project_date]=DESC`)
  ...
  return store.dispatch(fetchData(['testimony']))
    .then(() => {
