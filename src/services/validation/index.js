...
export const email = value => !isEmpty(value) && !isEmail(value) && { id: 'user.invalid_email', values: {} }
export const url = value => !isEmpty(value) && !isURL(value) && { id: 'user.invalid_url', values: {} }
