...
const AccountButton = ({ atTop, authenticated, toggleAccountNavigation, toggleSignInPopin, isLandingPage, firstName }) =>
  <Wrapper transparent={isLandingPage} atTop={atTop} onClick={authenticated ? toggleAccountNavigation : toggleSignInPopin}>
