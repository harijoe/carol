...
describe('contentReducer', () => {
  ...
  context('state = initialState and action.type = LATEST_PROJECTS_RESOURCES_RECEIVE and no posts returned', function() {
  ...
  context('state = initialState and action.type = LATEST_PROJECTS_RESOURCES_RECEIVE and a list of posts returned', function() {
    it('should be an object!', function() {
      const action = {
        type: 'LATEST_PROJECTS_RESOURCES_RECEIVE',
        projects: [
