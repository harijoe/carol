...
export default {
  '404.call_to_action': 'Revenir à l\'accueil ES',
  '404.message': 'Désolé, cette page n\'existe pas. ES',
  '404.title': '404.',
  ...
  'pages.default.meta.description': 'Quotatis vous permet d&apos;obtenir 5 devis gratuits sous trois jours. Demandes de devis comparatifs au 01.77.86.80.97 : devis travaux, devis pompe a chaleur, devis chauffage, devis defiscalisation, devis fenêtres, devis assurances, devis piscine, devis fenetres, devis climatisation, devis panneaux solaire photovoltaiques.... ES',
  'pages.default.meta.og.title': 'Devis Travaux - Comparer les prix avec 5 devis gratuits ES',
  'pages.default.title': 'Comparer les prix avec 5 devis gratuits ES',
  'pages.default.titleTemplate': 'Devis Travaux - %s ES',
  'pages.home.ld+json': '\\{ "@context": "http://schema.org", "@type": "Organization", "url": "https://www.quotatis.fr", "name": "Quotatis", "logo": "https://res.cloudinary.com/quotatis/image/upload/v1496149619/FrontApp/icons/quotatis-firm.svg", "sameAs": [ "https://www.facebook.com/Quotatis.FR", "https://twitter.com/QuotatisFr", "https://www.youtube.com/user/quotatis", "http://fr.viadeo.com/fr/company/quotatis", "https://www.linkedin.com/company/quotatis", "https://www.instagram.com/quotatis/" ] \\} ES',
  'pages.home.meta.description': 'Vous souhaitez effectuer des travaux pour votre maison ou appartement ? Quotatis vous met en relation avec des artisans de confiance dans votre région. ES',
  ...
  'project.describe.validated': 'Nous avons lancé la recherche de professionnels de confiance qui pourront répondre à votre projet. Vous recevrez leurs coordonnées par email et très prochainement vous pourrez directement consulter leurs fiches détaillées dans cet espace. ES',
  ...
  'project.notify_project_duplicated': 'Usted ya ha hecho la misma petición. Lo puede encontrar en mis proyectos.',
  ...
  'project.status.validated': 'Demande validée ES',
  ...
  'user.contact_info': 'Contact ES',
  'user.contact_preferences': 'Préférences de contact ES',
  ...
  'user.drop_text': 'Une photo de vous peut entraîner un dialogue plus humain et chaleureux avec l\'artisan. Alors n\'hésitez pas, surtout si vous en avez une sous la main. ES',
  ...
  'user.sign_in.introduction': 'Veuillez vous connecter pour continuer l\'élaboration de votre projet. Si vous n\'avez pas de compte, cliquez sur "Inscription" en bas de la page. ES',
  ...
  'user.social_network': 'Paramètre réseaux sociaux ES',
