const en = {
  ...
  'firm.faq': 'FAQ',
  'firm.list.good_news': 'Good news!',
  'firm.list.thank_you': 'Thank you!',
  'firm.list.has_results': 'has firms',
  'firm.list.no_results': 'no firms',
  ...
  'project.status.validated': 'Demande validée EN',
  ...
  'project.describe.validated': 'Nous avons lancé la recherche de professionnels de confiance qui pourront répondre à votre projet. Vous recevrez leurs coordonnées par email et très prochainement vous pourrez directement consulter leurs fiches détaillées dans cet espace. EN',
  ...
  'project.elaboration.summary.title': 'Pour lancer la recherche de professionnels, validez votre projet EN',
  'project.elaboration.summary.subtitle': 'Vous trouverez ci-joint le résumé de votre demande de projet EN',
  ...
  'user.sign_in.introduction': 'Veuillez vous connecter pour continuer l\'élaboration de votre projet. Si vous n\'avez pas de compte, cliquez sur "Inscription" en bas de la page. EN',
  ...
  'user.profile.email.not-validated': 'Unverified email address',
  'user.profile.email.validated': 'Verified email address',
  'user.profile.mobile.not-validated': 'Unverified mobile phone number',
  'user.profile.mobile.validated': 'Verified mobile phone number',
  'user.choose_img': 'Choose a picture',
  'user.drop_img': 'Try dropping some files here, or click to select files to upload.',
  'user.drop_text': 'Une photo de vous peut entraîner un dialogue plus humain et chaleureux avec l\'artisan. Alors n\'hésitez pas, surtout si vous en avez une sous la main. EN',
  ...
  'user.sms': 'SMS send',
  'user.sms_sent': 'A confirmation sms has been sent to you',
  'user.sms_sent_again': 'A new confirmation email has been sent to you',
  ...
  'footer.advices.window': 'Les Fenêtres EN',
  'footer.advices.shutter': 'Les Volets EN',
  'footer.advices.roof_insulation': 'L’Isolation des Combles EN',
  'footer.advices.wood_heating': 'Le Chauffage au bois EN',
  'footer.advices.heat_pumps': 'Les Pompes à chaleur EN',
  'footer.advices.solar_heating': 'Le Chauffage Solaire EN',
  'footer.advices.heating_gas_oil': 'Le Chauffage au Gaz et au Fioul EN',
  'footer.advices.electric_heating': 'Le Chauffage électrique EN',
  'footer.advices.fireplaces': 'Les Cheminées et Poêles EN',
  'footer.advices.heat_emitters': 'Emetteurs de chaleur EN',
  'footer.advices.domestic_hot_water_production': 'Production d’eau chaude sanitaire EN',

  'footer.corporate.contact': 'Contact EN',
  'footer.corporate.about': 'Qui sommes-nous ? EN',
  'footer.corporate.job': 'Recrutement EN',
  'footer.corporate.use_conditions': 'Conditions générales EN',
  'footer.corporate.guides': 'Guides pratiques EN',
  'footer.corporate.directory': 'Annuaire Artisan EN',
  'footer.corporate.qpro': 'Quotatis Pro EN',
  'footer.corporate.adeo': 'Groupe ADEO EN',
  'footer.corporate.quote': 'Devis travaux EN',
  'footer.corporate.folder_projects': 'Dossiers travaux EN',
  'footer.corporate.trades': 'Tous les métiers EN',
  'footer.corporate.phone_help': 'Besoin d\'aide ? EN',
  ...
  '404.call_to_action': 'Revenir à l\'accueil EN',
}
