const fr = {
  ...
  'project.list.heading.1': 'Bonne nouvelle !',
  'project.list.heading.2': 'Merci !',
  'project.list.description.1': 'Nous avons dans notre réseau plusieurs professionnels de confiance pouvant répondre à votre projet. Afin de vérifier leur disponibilités et en sélectionner jusqu\'à 5 qui vous contacteront pour établir un devis, veuillez valider votre projet.',
  'project.list.description.2': 'À l\'heure actuelle, nous n\'avons pas trouvé suffisament de professionnels disponibles pour répondre à votre demande. Afin de continuer notre recheche vérifier et sélectionner jusqu\'à 5 qui vous contacteront pour établir un devis, veuillez valider votre projet.',
